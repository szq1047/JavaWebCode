...
/**
 * Servlet implementation class addNewRoomInfo
 */
@WebServlet("/addNewRoomInfo")
public class addNewRoomInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addNewRoomInfo() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=roomdb.addRoomInfo(roomInfo);
		if(result>0){
