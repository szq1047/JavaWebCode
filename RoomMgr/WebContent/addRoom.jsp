...
<body>
<form method="post" action="addNewRoom.do">
	<div class="main">
	<table class="style2">
		<tr>
			<td >房间编号</td><td><input type="text" name="rno"></td>
		</tr>
		<tr>
			<td>房间类型</td>
			
			<td>
				<select class="selectStyle" name="rstyle">
		...
		<tr>
			<td>房间价格</td><td><input type="text" name="rprice"></td>
		</tr>
		<tr>
			<td>房间状态</td>
			<td>
			<select class="selectStyle" name="rstate">
		...
		<tr>
			<td>房间号码</td><td><input type="text" name="rtel"></td>
		</tr>
