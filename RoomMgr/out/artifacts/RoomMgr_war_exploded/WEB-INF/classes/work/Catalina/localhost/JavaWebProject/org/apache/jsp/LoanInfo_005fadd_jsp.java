 ...
 * Generated at: 2015-08-17 07:54:20 UTC
...
public final class LoanInfo_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if(username==null){
      ...
      out.write("\r\n");
      out.write("<HTML><HEAD><TITLE>添加借阅信息</TITLE> \r\n");
      ...
      out.print(basePath );
      out.write("calendar1.js\"></script>\r\n");
      out.write("<script language=\"javascript\">\r\n");
      out.write("function GetDateNow(){\r\n");
      out.write("\tvar borrowDate=document.getElementById(\"loanInfo.borrowDate\");\r\n");
      out.write("\tvar returnDate=document.getElementById(\"loanInfo.returnDate\");\r\n");
      out.write("\tvar date = new Date();\r\n");
      out.write("\tvar dateFormat = date.getFullYear() + \"-\"+ (date.getMonth() + 1) + \"-\" + date.getDate();\r\n");
      out.write("\tborrowDate.value=dateFormat;\r\n");
      out.write("\tdate.setDate(date.getDate()+30);\r\n");
      out.write("\treturnDate.value= date.getFullYear() + \"-\"+ (date.getMonth() + 1) + \"-\" + date.getDate();\r\n");
      out.write("}\r\n");
      out.write("/*验证表单*/\r\n");
      ...
      // /LoanInfo_add.jsp(51,4) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setAction("LoanInfo/LoanInfo_AddLoanInfo.action");
      // /LoanInfo_add.jsp(51,4) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setMethod("post");
      // /LoanInfo_add.jsp(51,4) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setId("loanInfoAddForm");
      // /LoanInfo_add.jsp(51,4) name = onsubmit type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setOnsubmit("return checkForm();");
      // /LoanInfo_add.jsp(51,4) name = enctype type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_s_005fform_005f0.setEnctype("multipart/form-data");
      // /LoanInfo_add.jsp(51,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("      <select name=\"loanInfo.book.barcode\">\r\n");
          out.write("      ");
        ...
        for(Book book:bookList) {
          ...
          out.write("    <td width=70%>\r\n");
          out.write("      <select name=\"loanInfo.reader.readerNo\">\r\n");
          out.write("      ");
        ...
        for(Reader reader:readerList) {
          ...
          out.write("    <td width=70%><input type=\"text\" readonly id=\"loanInfo.borrowDate\"  name=\"loanInfo.borrowDate\"  onclick=\"GetDateNow()\"/>\r\n");
          out.write("    </td>\r\n");
          out.write("  </tr>\r\n");
          out.write("\r\n");
          out.write("  <tr>\r\n");
          out.write("    <td width=30%>归还时间:</td>\r\n");
          out.write("    <td width=70%><input type=\"text\" readonly id=\"loanInfo.returnDate\"  name=\"loanInfo.returnDate\" /></td>\r\n");
          out.write("  </tr>\r\n");
          out.write("\r\n");
  ...
  private boolean _jspx_meth_s_005ffielderror_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /LoanInfo_add.jsp(46,0) name = cssStyle type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
