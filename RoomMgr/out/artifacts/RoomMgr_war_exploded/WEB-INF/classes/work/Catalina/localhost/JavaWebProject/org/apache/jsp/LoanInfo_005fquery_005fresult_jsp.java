 ...
 * Generated at: 2015-08-17 08:11:23 UTC
...
public final class LoanInfo_005fquery_005fresult_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if(username==null){
      ...
      out.print(basePath );
      out.write("/LoanInfo/LoanInfo_QueryLoanInfo.action\";\r\n");
      ...
      out.write("        return ;\r\n");
      out.write("    }\r\n");
      out.write("    document.loanInfoQueryForm.currentPage.value = pageValue;\r\n");
      out.write("    document.forms[\"loanInfoQueryForm\"].action = \"");
      out.print(basePath );
      out.write("/LoanInfo/Book_QueryLoanInfoaction\";\r\n");
      out.write("    document.loanInfoQueryForm.submit();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function QueryLoanInfo() {\r\n");
      out.write("\tdocument.forms[\"loanInfoQueryForm\"].action = \"");
      out.print(basePath );
      out.write("/LoanInfo/LoanInfo_QueryLoanInfo.action\";\r\n");
      out.write("\tdocument.forms[\"loanInfoQueryForm\"].submit();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function OutputToExcel() {\r\n");
      out.write("\tdocument.forms[\"loanInfoQueryForm\"].action = \"");
      out.print(basePath );
      out.write("/LoanInfo/LoanInfo_QueryLoanInfoOutputToExcel.action\";\r\n");
      out.write("\tdocument.forms[\"loanInfoQueryForm\"].submit(); \r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      ...
      out.print(basePath );
      out.write("/LoanInfo/LoanInfo_QueryLoanInfo.action\" name=\"loanInfoQueryForm\" method=\"post\">\r\n");
      ...
      out.write("                <td width=\"95%\" class=\"STYLE1\"><span class=\"STYLE3\">你当前的位置</span>：[借阅信息管理]-[借阅信息查询]</td>\r\n");
      out.write("              </tr>\r\n");
      out.write("            </table></td>\r\n");
      ...
      out.write("  <tr>\r\n");
      out.write("  <td>\r\n");
      out.write("图书对象：<select name=\"book.barcode\">\r\n");
      out.write(" \t\t\t\t<option value=\"\">不限制</option>\r\n");
      out.write(" \t\t\t\t");
      ...
      out.print(bookTemp.getBarcode() );
      out.write('"');
      out.write('>');
      out.print(bookTemp.getBookName() );
      out.write("</option>\r\n");
      out.write(" \t\t\t   ");
      ...
      out.write("\r\n");
      out.write(" \t\t\t</select>\r\n");
      out.write("读者对象：<select name=\"reader.readerNo\">\r\n");
      out.write(" \t\t\t\t<option value=\"\">不限制</option>\r\n");
      out.write(" \t\t\t\t");
      ...
      out.write("\r\n");
      out.write(" \t\t\t   <option value=\"");
      out.print(readerTemp.getReaderNo() );
      out.write('"');
      out.write('>');
      out.print(readerTemp.getReaderName() );
      out.write("</option>\r\n");
      out.write(" \t\t\t   ");
      ...
      out.write("    <input type=submit value=\"查询\" onclick=\"QueryLoanInfo();\"  />\r\n");
      out.write("  </td>\r\n");
      out.write("</tr>\r\n");
      out.write("  <tr>\r\n");
      out.write("    <td><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n");
      ...
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">借阅编号</span></div></td>\r\n");
      out.write("            <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">图书对象</span></div></td>\r\n");
      out.write("            <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">读者对象</span></div></td>\r\n");
      out.write("            <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">借阅时间</span></div></td>\r\n");
      out.write("            <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">应归还时间</span></div></td>\r\n");
      out.write("             <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">实归还时间</span></div></td>\r\n");
      out.write("              <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">罚款金额</span></div></td>\r\n");
      out.write("               <td  height=\"22\" background=\"");
      out.print(basePath );
      out.write("images/bg.gif\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">还书</span></div></td>\r\n");
      ...
      out.print(loanInfo.getBook().getBookName() );
      out.write("</span></div></td>\r\n");
      out.write("            <td bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">");
      out.print(loanInfo.getReader().getReaderName() );
      out.write("</span></div></td>\r\n");
      out.write("            <td height=\"20\" bgcolor=\"#FFFFFF\"><div align=\"center\"><span class=\"STYLE1\">");
      ...
      out.write("            \t<a href=\"");
      out.print(basePath );
      out.write("LoanInfo/LoanInfo_ReturnBook.action?loadId=");
      out.print(loanInfo.getLoadId() );
      out.write("\">还书</a>\r\n");
      out.write("           \t\t </span>\r\n");
      out.write("           \t\t </div>\r\n");
      ...
      out.print(basePath );
      out.write("LoanInfo/LoanInfo_ModifyLoanInfoQuery.action?loadId=");
      out.print(loanInfo.getLoadId() );
      ...
      out.print(basePath  );
      out.write("LoanInfo/LoanInfo_DeleteLoanInfo.action?loadId=");
      out.print(loanInfo.getLoadId() );
      out.write("\" onclick=\"return confirm('确定删除本LoanInfo吗?');\">删除</a></span>\r\n");
      out.write("            </div></td>\r\n");
      out.write("          </tr>\r\n");
      out.write("          ");
	} 
