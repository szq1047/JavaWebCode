...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>借阅时间:</td>
    <td width=70%><input type="text" readonly  id="loanInfo.borrowDate"  name="loanInfo.borrowDate" onclick="SelectDate(this);" value='<%=loanInfo.getBorrowDate() %>'/></td>
  </tr>

  <tr>
    <td width=30%>归还时间:</td>
    <td width=70%><input type="text" readonly  id="loanInfo.returnDate"  name="loanInfo.returnDate" onclick="SelectDate(this);" value='<%=loanInfo.getReturnDate() %>'/></td>
  </tr>
